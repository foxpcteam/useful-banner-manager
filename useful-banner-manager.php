...
function useful_banner_manager_load() {
    ...
    if ( get_option( 'useful_banner_manager_version') == '1.0' || get_option( 'useful_banner_manager_version') == '1.0'){
    ...
    } elseif ( get_option( 'useful_banner_manager_version' ) === false ) {
...
function useful_banner_manager_menu() {
    ...
    if ( function_exists( 'add_submenu_page' ) ) {
		add_submenu_page( 'useful-banner-manager/useful-banner-manager-banners.php', __( 'Banners', 'useful-banner-manager' ), __( 'Banners', 'useful-banner-manager' ), 'manage_options', 'useful-banner-manager/useful-banner-manager-banners.php' );
	}
}
...
class useful_banner_manager_Rotation_Widget extends WP_Widget {
     ...
     function form( $instance ) {
        ...
        <?php
            ...
            <p><label><?php _e( 'Width of rotating banners:', 'useful_banner_manager' ); ?> <input name="<?php echo( $this->get_field_name( 'width' ) ); ?>" type="text" value="<?php echo( esc_attr( $width ) ); ?>" size="2" /></label></p>
            <p><label><?php _e( 'Height of rotating banners:', 'useful_banner_manager' ); ?> <input name="<?php echo( $this->get_field_name( 'height' ) ); ?>" type="text" value="<?php echo( esc_attr( $height ) ); ?>" size="2" /></label></p>
...
function add_useful_banner_manager_banners( $atts ) {
    ...
    if( ! empty( $banners ) ){
        ...
        foreach ( $banners as $banner ) {
            $banners_html .= '<div class="useful_banner_manager_banner">';
